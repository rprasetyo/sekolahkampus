...
/**
 * AssetItemSearch represents the model behind the search form of `app\models\AssetItem`.
 */
class AssetItemSearch extends AssetItem
{
    ...
    public function rules()
    {
        return [
            ...
            [['number1', 'number2', 'number3', 'picture1', 'picture2', 'picture3', 'id_kabupaten', 'id_kecamatan', 'id_kelurahan', 'bukti_kepemilikan','myPageSize'], 'safe'],
        ];
    }
...
//            'pagination' =>  ['pageSize' => $pageSize,],
        ...
        $this->load($params);
        $dataProvider->pagination->pageSize = ($this->myPageSize !== NULL) ? $this->myPageSize : 100;
